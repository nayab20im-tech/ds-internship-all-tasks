# 🏆 DevelopersHub Corporation - Complete Data Science Internship Tasks
...
- [Task 2 Dataset](https://www.kaggle.com/datasets/vjchoudhary7/customer-segmentation-tutorial-in-python)
- [Task 3 Dataset](https://archive.ics.uci.edu/ml/datasets/individual+household+electric+power+consumption)
- [Task 4 Dataset](https://www.kaggle.com/c/home-credit-default-risk/data)
- [Task 5 Dataset](https://www.kaggle.com/datasets/rohitsahoo/sales-forecasting)

## 🚀 How to Run on Kaggle
1. Create new Notebook on Kaggle
2. Add dataset from "Add Data" button
3. Copy code from respective task file
4. Run all cells
